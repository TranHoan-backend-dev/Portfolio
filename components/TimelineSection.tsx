          ...
          {TIMELINE.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <Card className="portfolio-card p-6 rounded-2xl shadow-xl border border-default-200 dark:border-default-800 bg-default-50 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:to-[#5a0fd8] dark:bg-opacity-8 hover:scale-[1.01] transition-transform">
